...
export default function BlogCTA({
  ...
  description = 'Discover how Teckonnect helps organizations modernize infrastructure, accelerate cloud adoption, and drive digital transformation with trusted technology solutions.',
