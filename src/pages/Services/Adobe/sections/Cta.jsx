      ...
      <div className={styles.ctaBox}>
        ...
        >
          <motion.h2 variants={textReveal}>
            Ready to streamline Adobe licensing and rollout
          </motion.h2>

          <motion.p variants={textReveal}>
            Talk to Teckonnect for expert guidance on new purchases, expansions,
            <br />
            deployments, and renewals. No oversell. No hand-off after sale.
          </motion.p>
