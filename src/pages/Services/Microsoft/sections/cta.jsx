      ...
      <div className={styles.ctaBox}>
        ...
        >
          <motion.h2 variants={textReveal}>
            Ready to modernize with Microsoft
          </motion.h2>

          <motion.p variants={textReveal}>
            Whether you need Microsoft 365 rollout or you're searching for a
            Dynamics 365 partner in Australia,
            <br /> Teckonnect helps you plan, deploy, secure, and optimize
            Microsoft solutions.
          </motion.p>

          <motion.div variants={textReveal}>
            <Link to="/contact">
              <button className={styles.ctaBtn}>Request a consultation</button>
            </Link>
          </motion.div>
        </motion.div>
      </div>
