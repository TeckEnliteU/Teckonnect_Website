      ...
      <div className={styles.ctaBox}>
        ...
        >
          <motion.h2 variants={textReveal}>
            Start Your Digital Workplace Transformation Today
          </motion.h2>

          <motion.p variants={textReveal}>
            Unlock the full potential of Microsoft Modern Workplace services
            with a partner that <br />
            understands enterprise challenges and delivers measurable outcomes.
          </motion.p>
