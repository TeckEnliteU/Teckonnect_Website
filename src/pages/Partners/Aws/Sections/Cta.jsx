      ...
      <div className={styles.ctaBox}>
        ...
        >
          <motion.h2 variants={textReveal}>
            Build, Scale, and Innovate with AWS
          </motion.h2>

          <motion.p variants={textReveal}>
            Take the next step in your cloud journey with Teckonnect. We help
            organisations unlock the full potential of AWS by creating flexible,
            high-performing cloud environments. Reach out to us to discuss how
            we can support your transformation with reliable and future-ready
            solutions.
          </motion.p>
