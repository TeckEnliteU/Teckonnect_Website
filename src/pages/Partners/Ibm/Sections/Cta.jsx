      ...
      <div className={styles.ctaBox}>
        ...
        >
          <motion.h2 variants={textReveal}>
            Unlock the Power of AI and Data with IBM
          </motion.h2>

          <motion.p variants={textReveal}>
            Work with Teckonnect to create intelligent, data-driven solutions
            powered by IBM technologies. From strategy to implementation, we
            help you build systems that enhance performance and drive
            innovation. Connect with our team to explore new possibilities for
            your business.
          </motion.p>
